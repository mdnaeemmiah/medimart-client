...
const healthcareProviders = [
    {
        ...
        description: "Specialist in internal medicine with a focus on personalized patient care and chronic disease management.",
        image: img1,
    },
    {
        id: 2,
        ...
        description: "Cardiologist providing expert heart care and preventive health solutions.",
        image: img2,
    },
    {
        id: 3,
        ...
        description: "Pediatrician offering compassionate and comprehensive care for children and infants.",
        image: img3,
    },
    {
        id: 4,
        ...
        description: "Orthopedic specialist focused on bone and joint health with advanced treatment options.",
        image: img4,
    },
    {
        id: 5,
        ...
        description: "Dermatologist skilled in skincare treatments, acne therapy, and cosmetic dermatology.",
        image: img5,
    },
    {
        id: 6,
        ...
        description: "Neurologist dedicated to treating brain and nerve disorders with a patient-centered approach.",
        image: img3,
    }
];
...
const Company = () => {
    return (
        <div className="max-w-7xl mx-auto p-6 bg-white rounded-xl shadow-md mt-10">
            <h2 className="text-3xl font-bold text-center text-purple-700 mb-6">Meet Our Healthcare Experts</h2>
            <Carousel 
